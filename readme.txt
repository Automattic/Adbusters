...
* Remove unsupported Adcentric buster
* Remove unsupported Adcade buster

= 1.0.5 =

* Remove unsupported Interpolls buster
* Remove unsupported SmartAdServer buster
...
* Removing various files with XSS vulnerabilities

= 1.0.1 =

* Added some DFP adbusters (props dlh)
